const data = [
  {
    ...
    description:
      "JSW Steel Grout SG 1 is a cementitious flow-able non-shrink high-strength grout for precision applications like repairing RCC Structures heavy machinery foundations etc.",
