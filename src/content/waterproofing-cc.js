const data = [
  {
    ...
    specificationsTable: [
      ...
      {
        property: "Setting time, min",
        testMethod: "IS 2645:2003",
        result: "Passes",
      },
      {
      ...
      {
        property: "Compressive strength N/mm2",
        testMethod: "IS 2645:2003",
        result: "As per standard",
      },
      {
        property: "Chloride",
        testMethod: "IS 2645:2003",
    ...
    specificationsTable: [
      {
        ...
        result: "Milky white liquid with translucence",
      },
      {
        property: "Material type",
        result: "Modified eco-friendly SBR latex",
      },
      {
        property: "Smell",
        result: "Characteristic sweet smell",
      },
      {
        property: "pH",
        result: "7-8",
      ...
      {
        property: "Total Active Content (by mass)",
        result: "38±1 %",
      },
      {
        property: "Specific Gravity at 25 °C",
        result: "1.0-1.05",
      },
    ],
  },
  ...
  },
  {
    ...
    specificationsTable: [
      {
        property: "Nature/Appearence",
        result: "Two component (1 part liq. Polymer + 2 part powder)",
      },
      {
        property: "Appearence",
        result: "Liquid Part: Milky White Powder: Grey Slurry Density",
      },
      {
        property: "Wet mix slurry density",
        result: "1.5-1.6 g/cc",
      },
      {
        property: "pH of slurry",
        result: "9-11",
      },
      {
        property: "Pot life of the Mix at 30 °C",
        result: "Minimum 45 min.",
      },
      {
        property: "Elongation at break of dry film",
        result: "Minimum 60%",
      },
    ],
  },
  {
    ...
    specificationsTable: [
      ...
      {
        property: "Appearence",
        result: "Liquid Part: Milky White Powder: Grey powder",
      },
      {
        property: "Wet mix slurry density",
        result: "1.5-1.6 g/cc",
